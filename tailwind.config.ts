      ...
      typography: {
        DEFAULT: {
          css: {
            ...
            h2: { fontFamily: 'var(--font-fraunces), Georgia, serif', fontWeight: '700', color: '#1A1A1A', marginTop: '2.5rem', marginBottom: '1rem' },
            h3: { fontFamily: 'var(--font-fraunces), Georgia, serif', fontWeight: '700', color: '#1A1A1A' },
