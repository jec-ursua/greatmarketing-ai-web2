    ...
    <>
      ...
      <section className="py-24 bg-brand-dark text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <HireUsButton payload={{ sourceSurface: 'facebook-advertising-agency' }} className="inline-flex items-center gap-2 px-10 py-5 rounded-full bg-brand-gold hover:bg-brand-gold-dark text-neutral-900 font-bold text-lg transition shadow-2xl">
