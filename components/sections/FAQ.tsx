...
const FAQS = [
  ...
  },
  {
    ...
    a: "While no marketing agency can guarantee specific case volume or court outcomes, we focus on high-performance execution and exclusive territory rights that maximize your probability of success. Every lead we deliver is pre-vetted through our AI qualification system, giving your intake team the highest probability of converting leads into signed retainers. We also back our work with performance-based reporting. You'll receive weekly updates on lead volume, qualification rates, and signed cases, so you can see exactly how your investment is performing at every stage.",
  },
  {
  ...
  {
    q: 'What types of personal injury cases do you generate leads for?',
    a: "We generate exclusive leads across every major type of personal injury case. Our flagship is motor vehicle accidents, including auto accidents, truck accidents, motorcycle accidents, rideshare accidents (Uber and Lyft), and commercial vehicle collisions. We're also expanding into slip & fall injuries, medical malpractice, wrongful death, and premises liability cases. Each campaign is targeted specifically to the case types most valuable to your firm. Our AI-powered qualification system pre-vets every lead against your firm's specific criteria, such as injury severity, liability indicators, insurance coverage, and statute of limitations, so your intake team only speaks with prospects who match the cases your firm actually wants to sign.",
  },
];
